...
const timelineItems = [
  // Education
  { type: "education", date: "2025-05", year: 2025, title: "MS in Machine Learning", organization: "Georgia Tech", location: "Atlanta, GA", bullets: ["GPA: 3.83", "Core: Computer Vision, Deep Learning, Knowledge-Based AI"] },
  { type: "education", date: "2024-05", year: 2024, title: "BS in Computer Science", organization: "Georgia Tech", location: "Atlanta, GA", bullets: ["GPA: 4.0", "Core: Algorithms, Systems & Networks, Computational Complexity"] },
  ...
  { type: "education", date: "2021-05", year: 2021, title: "Dual Enrollment Complete", organization: "Georgia Tech", location: "Atlanta, GA", bullets: ["Non-Degree in Computational & Applied Mathematics", "GPA: 4.0"] },
        ...
        >
          {years.map((year) => (
            <>
              ...
              {groupedByYear[year].map((item: typeof timelineItems[number], idx: number) => {
